...
<body>
    ...
    <div class="gcp-sidebar p-3">
        <ul class="nav flex-column gap-1">
            ...
            <li class="nav-item"><a class="nav-link text-dark active fw-medium p-2 rounded nav-link-active" href="flaky.html">Flaky tests</a></li>
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="mb-0 fw-normal">Flaky tests</h4>
        </div>
